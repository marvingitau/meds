...
@section('content')
 <!--breadcrumbs-->
    ...
    <div class="widget-content" >
        <div class="row-fluid">
        <div class="contaner ">
            <div class="nav flex-column nav-pills w-50 float-left ord_review_menu" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                @if ( $allOrders)
                <?php $jounter=-1; ?>
            ...
            <div class="tab-content w-50 float-left" id="v-pills-tabContent">
                ...
                <?php $counter=-1; ?>
                                ...
                                <div class="tab-pane fade <?php echo $counter===0 ? 'show active':''; ?>  ord_review_content" id="v-pills-home-<?php echo $counter; ?>" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                    <table class="table">
                                    <thead>
                                        <tr>Order ID: {{ $allOrders[$counter]->id }}</tr>
                                        <tr>
                                            <td>Item ID</td>
                                            <td>Name</td>
                                            <td>Price</td>
